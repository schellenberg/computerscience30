...
function saveMaze(filename) {
  let stringVersionOfMaze = JSON.stringify(grid);
  let blob = new Blob([stringVersionOfMaze], {type: "text/javascript;charset=utf-8"});
  saveAs(blob, filename + ".js", true);
}
