...
function updateDisplay() {
  if (!gameIsOver) {
    ...
    const spacerWidth = max(textWidth(" "), textSizeVariable * 0.28);
    ...
    fill(0, 0, 255);
    text(computerGuess, width/2 - textSizeVariable*2.7 + textWidth(predictMessage) + spacerWidth, height/2 - textSizeVariable*2.5);
    fill(0, 255, 0);
    text(userChoice, width/2 - textSizeVariable*2.7 + textWidth(youPickedMessage) + spacerWidth, height/2 - textSizeVariable);
