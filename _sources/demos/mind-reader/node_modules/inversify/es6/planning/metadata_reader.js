...
class MetadataReader {
    getConstructorMetadata(constructorFunc) {
        var _a;
        const compilerGeneratedMetadata = (_a = Reflect.getMetadata(METADATA_KEY.DESIGN_PARAM_TYPES, constructorFunc)) !== null && _a !== void 0 ? _a : [];
    ...
    getPropertiesMetadata(constructorFunc) {
        var _a;
        const userGeneratedMetadata = (_a = Reflect.getMetadata(METADATA_KEY.TAGGED_PROP, constructorFunc)) !== null && _a !== void 0 ? _a : {};
