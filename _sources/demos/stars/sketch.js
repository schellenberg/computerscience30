...
//Dan Schellenberg
//Feb 24, 2018 - p5js v1
//updated to p5js version 2 on June 10, 2026
...
async function setup() {
  starChart = await loadStrings("stars.txt");
  constellation = await loadStrings("BigDipper_lines.txt");
...
async function loadConstellationFile() {
  print(selectConstellation.value());
  constellation = await loadStrings(selectConstellation.value());
  drawConstellation();
}
